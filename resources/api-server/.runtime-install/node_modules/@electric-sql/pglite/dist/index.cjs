...
shared_preload_libraries=${r.join(",")}`}Vt(this.mod.FS,`${z}/postgresql.conf`,new TextEncoder().encode(o))}},_s=async function(r){E(this,R,fe).call(this,`pglite: icuDataDir specified, removing default icu data dir at ${De}`),j.rmdirRecursive(this.mod.FS,De),E(this,R,fe).call(this,`pglite: loading icu data from tarball ${r}`),this.mod.FS.mkdirTree(De),await Fr(this.mod.FS,r,De)},is=function(r){w(this,rr,r.addFunction(a=>(E(this,R,fe).call(this,`Postgres tried to execute ${r.UTF8ToString(a)}, returning 1.`),1),"pi")),r._pgl_set_system_fn(p(this,rr)),w(this,ar,r.addFunction((a,o)=>{let s=r.UTF8ToString(o),n=r.UTF8ToString(a);return this.externalCommandStreamFd=this.handleExternalCmd(n,s),this.externalCommandStreamFd},"ppp")),r._pgl_set_popen_fn(p(this,ar)),w(this,or,r.addFunction(a=>{if(a===this.externalCommandStreamFd)this.mod._fclose(this.externalCommandStreamFd),this.externalCommandStreamFd=null;else throw`Unhandled pclose ${a}`;E(this,R,fe).call(this,"pclose_fn",a)},"pi")),r._pgl_set_pclose_fn(p(this,or)),w(this,Et,r.addFunction((a,o)=>{let s;try{s=this.mod.HEAPU8.subarray(a,a+o)}catch(n){throw console.error("error",n),n}return p(this,xe).call(this,s)},"iii")),w(this,vt,r.addFunction((a,o)=>{let s=p(this,Ae).length-p(this,be);return s>o&&(s=o),this.mod.HEAP8.set(p(this,Ae).subarray(p(this,be),p(this,be)+s),a),w(this,be,p(this,be)+s),s},"iii")),r._pgl_set_rw_cbs(p(this,vt),p(this,Et))},ls=function(r){let a=r.slice(),o=p(this,ce)+a.length;if(o>p(this,pe).length){let s=p(this,pe).length+(p(this,pe).length>>1)+o;o>ie.MAX_BUFFER_SIZE&&(o=ie.MAX_BUFFER_SIZE);let n=new Uint8Array(s);n.set(p(this,pe).subarray(0,p(this,ce))),w(this,pe,n)}return p(this,pe).set(a,p(this,ce)),w(this,ce,p(this,ce)+a.length),E(this,R,Aa).call(this,a)},Aa=function(r){return p(this,ht).parse(r,a=>{let o=E(this,R,ds).call(this,a);o&&p(this,$).results.push(o)}),r.length},ds=function(r){if(!p(this,$).databaseError){if(r instanceof me)p(this,$).throwOnError&&(p(this,$).databaseError=r);else if(r instanceof je)this.debug>0&&console.warn(r),p(this,$).onNotice&&p(this,$).onNotice(r);else if(r instanceof He){let a=p(this,le).get(r.channel);a&&a.forEach(o=>{queueMicrotask(()=>o(r.payload))}),p(this,et).forEach(o=>{queueMicrotask(()=>o(r.channel,r.payload))})}return r}return null},fe=function(...r){this.debug>0&&console.log(...r)},us=async function(r,a,o){let s=j.toPostgresName(r),n=o??this;p(this,le).has(s)||p(this,le).set(s,new Set),p(this,le).get(s).add(a);try{await n.exec(`LISTEN ${r}`)}catch(_){throw p(this,le).get(s).delete(a),p(this,le).get(s)?.size===0&&p(this,le).delete(s),_}return async _=>{await this.unlisten(s,a,_)}},ps=async function(r,a,o){let s=j.toPostgresName(r),n=o??this,_=async()=>{await n.exec(`UNLISTEN ${r}`),p(this,le).get(s)?.size===0&&p(this,le).delete(s)};a?(p(this,le).get(s)?.delete(a),p(this,le).get(s)?.size===0&&await _()):await _()},cs=function(){if(p(this,Mt))throw new Error("PGlite single mode already running");this.mod._pgl_startPGlite(),w(this,Mt,!0)},ms=function(r){let a=[...r.startParams,"-D",r.pgDataFolder,this.mod.ENV.PGDATABASE];if(this.mod.callMain(a)!==99)throw new Error("PGlite failed to initialize properly")},gs=function(r){w(this,be,0),w(this,ce,0),w(this,Ae,r);let a=this.mod._pgl_getMyProcPort();if(this.mod._ProcessStartupPacket(a,!0,!0)!==0)throw new Error(`Cannot process startup packet + ${r.toString()}`);return this.mod._pgl_sendConnData(),this.mod._pgl_pq_flush(),w(this,Ae,[]),p(this,ce)?p(this,pe).subarray(0,p(this,ce)):new Uint8Array(0)},ie.paths={PG_ROOT:W,PGDATA:z,ICU_DATA_PATH:De,INITDB_EXE_PATH:Tr,POSTGRES_EXE_PATH:kr},ie.DEFAULT_RECV_BUF_SIZE=1*1024*1024,ie.MAX_BUFFER_SIZE=Math.pow(2,30),ie.defaultStartParams=["--single","-F","-O","-j","-c","search_path=public","-c","exit_on_error=false","-c","log_checkpoints=false","-c","max_worker_processes=0","-c","max_parallel_workers=0","-c","max_parallel_workers_per_gather=0","-c","io_method=sync","-c","max_parallel_maintenance_workers=0"];var Pa=ie;x();x();async function hs(e,t,r,a){if(!r||r.length===0)return t;a=a??e;let o=[];try{await e.execProtocol(U.parse({text:t}),{syncToFs:!1}),o.push(...(await e.execProtocol(U.describe({type:"S"}),{syncToFs:!1})).messages)}finally{o.push(...(await e.execProtocol(U.sync(),{syncToFs:!1})).messages)}let s=St(o),n=t.replace(/\$([0-9]+)/g,(l,d)=>"%"+d+"L");return(await a.query(`SELECT format($1, ${r.map((l,d)=>`$${d+2}`).join(", ")}) as query`,[n,...r],{paramTypes:[yt,...s]})).rows[0].query}0&&(module.exports={IdbFs,MemoryFS,Mutex,PGlite,formatQuery,messages,parse,protocol,types});
